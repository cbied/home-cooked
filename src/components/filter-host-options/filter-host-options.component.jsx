...
const FilterHostOptions = () => {
	...
	const CustomButtonGroup = ({ appearance }) => (
		<ButtonToolbar>
			<ButtonGroup style={{ marginTop: 12, width: '40rem' }} justified>
				<Button
					size='lg'
					appearance={appearance}
					onClick={() => handleSetCookOption(1)}
					style={
						dinnerOption.includes(1)
	...
	return (
		<Form className='min-h-80 flex flex-col justify-around p-10'>
			<Form.Group controlId='cookOption' className='flex flex-col'>
				<Form.ControlLabel className='text-3xl font-bold ml-5'>
					Experience Type
				</Form.ControlLabel>
				<p className='ml-5'>
					learn to cook, learn to cook and have dinner, or just show
					up and have dinner
				</p>
			...
			<Form.Group controlId='priceRange' className='flex flex-col'>
				...
				<p className='ml-5 mb-10'>
					dinner experience price range before taxes and fees
				</p>
				<RangeSlider
					max={250}
					min={25}
				...
				>
					<Grid>
						<Row className='h-24'>
							<Col
								xs={3}
								className='h-56 flex flex-col justify-around mr-3'
							>
							...
							>
								...
								<Checkbox value='Portuguese'>
									Portuguese
								</Checkbox>
								<Checkbox value='Thai'>Thai</Checkbox>
								<Checkbox value='Vietnamise'>
									Vietnamise
								</Checkbox>
							</Col>
							<Col
